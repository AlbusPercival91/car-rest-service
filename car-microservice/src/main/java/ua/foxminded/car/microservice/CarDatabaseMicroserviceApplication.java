package ua.foxminded.car.microservice;
...
public class CarDatabaseMicroserviceApplication {

    public static void main(String[] args) {
        initializeDatabase();
        SpringApplication.run(CarDatabaseMicroserviceApplication.class, args);
    }

    private static void initializeDatabase() {
        String initialScriptFileName = "initDatabase.sql";

        try (InputStream is = CarDatabaseMicroserviceApplication.class.getResourceAsStream("/" + initialScriptFileName);
